...
payload_size = x64dbg.ReadDword(addr + 12)
...
# Shellcode
shellcode_addr = x64dbg.ReadPtr(payload_base + 4)
shellcode_size = x64dbg.ReadDword(payload_base + 8)
...
# Packed payload
packed_payload_addr = x64dbg.ReadPtr(payload_base + 0xC)
packed_payload_size = x64dbg.ReadDword(payload_base + 0x10)
...
# Configuration data
cfg_addr = x64dbg.ReadPtr(payload_base + 0x14)
cfg_size = x64dbg.ReadDword(payload_base + 0x18)
